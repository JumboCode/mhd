...
const DEFAULT_MAP_STYLE = "/maps/positron.json";
...
type MapProps = {
    children?: ReactNode;
    /** Custom map style. Defaults to protomaps_light. */
...
const Map = forwardRef<MapRef, MapProps>(function Map(
    { children, style: styleProp, projection, ...props },
    ref,
) {
    ...
    const mapStyle = styleProp ?? DEFAULT_MAP_STYLE;
    ...
    const handleLocate = useCallback(() => {
        ...
        if ("geolocation" in navigator) {
            navigator.geolocation.getCurrentPosition(
                ...
                () => {
                    toast.error(
                        "Error getting location. Please check your permissions.",
                    );
                    setWaitingForLocation(false);
                },
            );
